<?php
// Heading
$_['heading_title']          = 'Osongw';
$_['text_edit']              = 'Изменить настройки';

// Text
$_['text_extension']	    = 'Расширения';
$_['text_success']        = 'Вы успешно изменили настройки модуля';
$_['text_osongw']      = '<img src="view/image/payment/osongw.png" alt="" title="" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_domain_payment_page']      = 'Адрес сервера Oson';
$_['entry_domain_payment_page_help'] = 'Адрес сервера Oson, полученный от вашей платежной компании';
$_['entry_payment_type']		= 'Способ оплаты';
$_['entry_payment_type_card']		= 'Оплата картой через Oson Payment';
